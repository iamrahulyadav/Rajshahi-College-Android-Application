...
public class Vice_Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vice__principal);
    ...
    void setUpMyViewPager(ViewPager vp){
        ...
        vpa.addMyFragment(new Vice_Principal_Image(), "Image");
        vpa.addMyFragment(new Vice_Principal_Message(), "Message");
        vpa.addMyFragment(new Vice_Principal_LifeSketch(), "Life Sketch");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_vice__principal, menu);
        return true;
    }
