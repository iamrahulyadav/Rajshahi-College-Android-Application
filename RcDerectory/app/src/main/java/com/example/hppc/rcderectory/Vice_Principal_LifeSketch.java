...
public class Vice_Principal_LifeSketch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        v3 = inflater.inflate(R.layout.fragment_viceprincipal_lifesketch, container, false);

        vp_lifeSketch = (WebView)v3.findViewById(R.id.viceprincipal_lifesketch);
